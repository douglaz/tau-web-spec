# Recipes are instructions the AI reads, not scripts it executes
...
authoring a new recipe when none fits. Rejected despite two real advantages: it makes
...
come from the AI writing back into recipes as a deliberate feature, not as a side
