...
| 3 | Relay admission (the rules are paid-tcp-relay's since 2026-09-24; the module ports with T30) | `CHN-15`, `CHN-16`, `CHN-16a`, `relay-protocol-v1.md` | "No dial before OK" as one invariant instead of two (fixed 2026-09-16); a hostname re-entering the dialer after validation |
