...
| `inference.toml` | The procured aggregator, the model the first stage runs under, the requested provider and retention tier | `ARC-31`, `ARC-31a`, `ARC-31b`, `TRU-A1a`, `CNF-71`, `CNF-78` |
