...
| `inference.toml` | The procured aggregator, candidate order with makers, publisher allowlist, context floor and depth, requested provider and retention tier | `ARC-31`, `ARC-31a`, `ARC-31b`, `TRU-A1a`, `CNF-71`, `CNF-78` |
